  ...
  return (
    <div className="bBlocksTestPurpose">
      ...
      {purposeType === "default" ? (
        ...
        <p>
          If someone sends you an invitation to a party, for example, they are
          telling you what time to arrive and what the sender is celebrating,
          and they might even.
        </p>
      )}
    </div>
